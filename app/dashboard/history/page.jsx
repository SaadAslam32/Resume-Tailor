      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 bg-white p-6 rounded-2xl shadow-lg">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-gray-600 mt-1">Previously tailored resumes</p>
          </div>
          <button
            onClick={() => router.push('/dashboard')}
            className="flex items-center bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-5 py-2.5 rounded-xl hover:opacity-90 transition shadow-md"
          >
        ...
        <div className="bg-white shadow-xl rounded-2xl p-6 mb-8 border border-gray-100">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Your Resume History</h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-10">
              ...
              <h3 className="text-xl font-medium text-gray-700">No resume history found</h3>
              <p className="mt-2 text-gray-500">Your tailored resumes will appear here</p>
              <button
                onClick={() => router.push('/dashboard')}
                className="mt-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-xl hover:opacity-90 transition shadow-md"
              >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="p-6 overflow-y-auto flex-grow">
              <div className="bg-gray-100 rounded-xl p-6 mb-4 max-h-[50vh] overflow-y-auto">
            ...
            <div className="p-6 bg-gray-50 flex justify-center space-x-4">
              <button
                ...
                className={`flex items-center px-6 py-3 rounded-xl font-medium transition ${
                  isDownloading
                    ...
                    : 'bg-gradient-to-r from-green-600 to-teal-600 text-white hover:opacity-90 shadow-md'
                }`}
              >
                {isDownloading ? (
                  <>
              ...
              <button
                onClick={() => setSelectedResume(null)}
                className="bg-gradient-to-r from-gray-600 to-gray-700 text-white px-6 py-3 rounded-xl hover:opacity-90 transition"
              >
                Close
              </button>
            </div>
